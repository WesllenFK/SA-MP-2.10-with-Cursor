# Sistema de Sinuca - Tabela de Offsets
...
| Função | Offset 32-bit | Offset 64-bit | Status |
|--------|---------------|---------------|--------|
...
### CCollision - Esfera vs Box/Triângulo
...
| Variável | Offset 32-bit | Offset 64-bit | Status |
|----------|---------------|---------------|--------|
...
## 6. Arquivos Fonte (do dump 64-bit)

| Arquivo | Descrição |
|---------|-----------|
| `../FrontEnd/WidgetPool.cpp` | Widget principal de sinuca |
| `../FrontEnd/WidgetRegionPoolBallInHand.cpp` | Widget de posicionamento da bola |
| `../FrontEnd/WidgetRegionPoolEnglish.cpp` | Widget de efeito english |

---

## Notas de Uso

### Para Hooks de Física (Tacada)
...
// Uso: aplicar força com efeito english
...
// Uso: verificar colisão entre duas bolas
CColPoint colPoint;
float depth;
...
// Verificar se bola está dentro da mesa
